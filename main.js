...
async function getUser(username) {
  try {
    ...
    createErrorCard("Üzgünüz, aradığınız kullanıcıyı bulamadınız...");
  }
}
  ...
  const cardHTML = `
     <div class="card">
        ...
        <ul>
          ...
          <li>
            <i class="fa-solid fa-users"></i> ${user.following} <strong>Following</strong>
          </li>
          <li>
...
async function getRepos(username) {
  try {
    ...
    createErrorCard("Üzgünüz, repoları çekerken bir hata oluştu...");
  }
}
